...
exports.getFilial = function(id_empresa,id_filial,id){
	strSql = ` select   
			...
			,  filial.user_update as  user_update    
 			FROM filiais filial 	     
			 where filial.id_empresa = ${id_empresa} and  filial.id_filial = ${id_filial} and  filial.id = ${id}  `;
...
/* CRUD - UPDATE */
 exports.updateFilial = function(filial){
	strSql = `update   filiais set  
 		 ...
 		 where id_empresa = ${filial.id_empresa} and  id_filial = ${filial.id_filial} and  id = ${filial.id}  returning * `;
	return  db.oneOrNone(strSql);
}
/* CRUD - DELETE */
